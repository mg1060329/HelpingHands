package com.helpinghands.partner.adepter;
...
import com.helpinghands.partner.activity.ServiceDetailActivity;
...
public class NewSearviceAdapter extends RecyclerView.Adapter<NewSearviceAdapter.NewsHolder> {
    ...
    private List<OrderDataItem> itemList;
    ...
    public void onBindViewHolder(@NonNull NewsHolder holder, int position) {
        ...
        holder.lvlClick.setOnClickListener(v -> context.startActivity(new Intent(context, ServiceDetailActivity.class)
